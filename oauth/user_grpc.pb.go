...
type UserRouteClient interface {
	...
	BulkCreateUsers(ctx context.Context, in *CreateUsersParams, opts ...grpc.CallOption) (*UsersResponse, error)
}
...
func (c *userRouteClient) BulkCreateUsers(ctx context.Context, in *CreateUsersParams, opts ...grpc.CallOption) (*UsersResponse, error) {
	out := new(UsersResponse)
	err := c.cc.Invoke(ctx, "/oauth.UserRoute/BulkCreateUsers", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type UserRouteServer interface {
	...
	BulkCreateUsers(context.Context, *CreateUsersParams) (*UsersResponse, error)
...
func (UnimplementedUserRouteServer) BulkCreateUsers(context.Context, *CreateUsersParams) (*UsersResponse, error) {
...
func _UserRoute_BulkCreateUsers_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(CreateUsersParams)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(UserRouteServer).BulkCreateUsers(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/oauth.UserRoute/BulkCreateUsers",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(UserRouteServer).BulkCreateUsers(ctx, req.(*CreateUsersParams))
	}
	return interceptor(ctx, in, info, handler)
}
